var eds = function () {
                ...
                $(data).filter(function (i, e) {
                    ...
                    if (e.Rtype === 1) {
                        ...
                        $(data).filter(function (i1, e1) {
                            ...
                            //递归调用，显示子节点
                            html.push(showSideBarSon(e2, data));
                        });
                    }
                });
    ...
    function showSideBarSon(cur, data) {
        var html = [];
        //有子菜单
        if (cur.SonNum > 0) {
    ...
    //全选和单选联动
    var chkAllSingleInit = function (chkAllSelector, chkSingleSelector) {
    ...
    var getEditableParam = function (url, validate, refreshPk) {
