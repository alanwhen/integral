...
func (this *SchoolController) Prepare() {
...
func (this *SchoolController) Index() {
	...
	this.setTpl("admin/school/index.html")
	this.LayoutSections = make(map[string]string)
	this.LayoutSections["header"] = "admin/school/index_header.html"
	this.LayoutSections["footer"] = "admin/school/index_footer.html"
...
func (this *SchoolController) DataGrid() {
...
func (this *SchoolController) Edit() {
	if this.Ctx.Request.Method == "POST" {
		this.Save()
	}

	Id, _ := this.GetInt(":id", 0)
	m := models.School{Id: Id}
	if Id > 0 {
		o := orm.NewOrm()
		err := o.Read(&m)
		if err != nil {
...
func (this *SchoolController) Save() {
	var err error
	m := models.School{}
...
func (this *SchoolController) Delete() {
	...
	if num, err := models.SchoolBatchDelete(ids); err == nil {
